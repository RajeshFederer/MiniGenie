...
actionObject.Welcome = (req, res, recipientId) =>{
  ...
  let welcomeMsg = "Hey! I'm The Mini Genie Bot. I can help you to create/check incidents. Tell me what I can do for you. Create New Incident or Check Incidents";
    ...
    //logChats(recipientId, welcomeMsg);
...
actionObject['input.unknown'] = (req, res) => {
  ...
  logChats("2131494240194398", req, "HEY! I can only help you to create/check incidents.");
  return res.json(resObj);
};
...
let logChats = (recipientId, req, res) =>{
  
  console.log('I am in', recipientId, JSON.stringify(req.body), res);
  const logger = winston.createLogger({
    transports: [
      new winston.transports.File({
        filename: '../logs/fb/'+ recipientId+'.log',
        level: 'info'
      })
    ]
  });
