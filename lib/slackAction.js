        ...
        let resObj = {
          ...
          "messages": [
            ...
            },
            {
              "type": 1,
              "platform": "slack",
              "title": "Status: "+ data.status[body.result[0].state],
              "subtitle": "Priority: " + data.priority[body.result[0].priority] + "\n Created On: "+ body.result[0].sys_created_on+ "\n Updated On: "+ body.result[0].sys_updated_on,
