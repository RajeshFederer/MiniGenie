...
actionObject.getIncident = (req, res) =>{
  if(!req.body.result.parameters.incidentNo){
    let resObj =  {
      "speech": "Please Enter your Incident Id",      
      followupEvent :{
          "name" : "getIncident",
          "data" : {incidentReqType:req.body.result.parameters.incidentReqType}
      }
    };
    return res.json(resObj);
  } else if(req.body.result.parameters.incidentNo.toUpperCase.indexOf('INC') != 0) {
