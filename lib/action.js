...
actionObject.getIncident = (req, res) =>{
  req.body.result.parameters.incidentNo.toUpperCase = req.body.result.parameters.incidentNo.toUpperCase.toString();
  if(req.body.result.parameters.incidentNo.toUpperCase.indexOf('INC') != 0) {
