        ...
        let resObj = {
          ...
          "messages": [
            ...
            },
            {
              "type": 1,
              "platform": "slack",
              "title": "Status: "+ data.status[body.result[0].state] ? data.status[body.result[0].state] : "CLOSED",
              "subtitle": "Priority: " + data.priority[body.result[0].priority] ? data.priority[body.result[0].priority] : "CLOSED",
              "imageUrl": "http://passionfire.com/wp-content/uploads/2012/08/mlm-right-person.jpg",
              "buttons": []
            },
            {
              "type": 2,
