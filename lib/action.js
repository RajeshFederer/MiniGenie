...
actionObject['createIncident.urgeny'] = (req, res) => {
  ...
  serviceNow.callServiceNow("POST", serviceNowUrl, reqObj)
  .then(body =>{
...
actionObject.getIncident = (req, res) =>{
  ...
  let serviceNowUrl = 'https://dev18442.service-now.com/api/now/v1/table/incident/'+req.body.result.parameters.incidentNo;
  
  serviceNow.callServiceNow("GET",serviceNowUrl)
  .then(body => {
