...
actionObject['createIncident.urgeny'] = (req, res) => {
  ...
  if(!req.body.result.parameters.urgency){
    console.log('RECIVED URGENCY ', req.body.result.parameters.urgency, actionData, JSON.stringify(req.body.result));
    ...
    console.log('RECIVED EMPID ', req.body.result.parameters.empId, actionData, JSON.stringify(req.body.result));
    ...
    req.body.result.parameters.urgency = actionData.urgency;
    console.log('RECIVED EMPID VAL ', req.body.result.parameters.empId, actionData, JSON.stringify(req.body.result));
